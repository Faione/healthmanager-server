package stu.swufe.healthmanager.response;
...
public class ResponseResult {
     ...
     */
    // 普通错误
    public static ResponseResult creatFailed(){return new ResponseResult(ResponseState.FAILED); }

    // 特殊的错误
    public static ResponseResult creatFailed(ResponseState responseState){
        return new ResponseResult(responseState); }

    // 返回错误信息
    public static ResponseResult creatFailed(String msg){
        return new ResponseResult(ResponseState.FAILED).setMsg(msg);
    }
